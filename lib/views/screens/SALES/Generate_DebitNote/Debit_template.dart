...
Future<Uint8List> generate_Debit(PdfPageFormat pageFormat, products, client_addr_name, client_addr, bill_addr_name, bill_addr, Debit_num, title) async {
                    ...
                    pw.Column(
                      ...
                      children: [
                        ...
                        pw.Container(
                          child: pw.Align(
                            alignment: pw.Alignment.centerLeft,
                            child: regular("DebitAA/INST/241101", 10),
                          ),
                        ),
                      ],
                    ),
            ...
            children: [
              ...
              pw.Padding(
                ...
                child: pw.Row(
                  crossAxisAlignment: pw.CrossAxisAlignment.start,
                  children: [
                    // regular("${Debit_noteList.length + 1}.", 10),
                    // pw.SizedBox(width: 5),
                    // pw.Expanded(
                    //   child: pw.Column(
                    //     crossAxisAlignment: pw.CrossAxisAlignment.start,
              ...
              pw.Padding(
                ...
                child: pw.Row(
                  crossAxisAlignment: pw.CrossAxisAlignment.start,
                  children: [
                    // regular("${Debit_noteList.length + 2}.", 10),
                    pw.SizedBox(width: 5),
                    pw.Expanded(
                      child: pw.Column(
                        crossAxisAlignment: pw.CrossAxisAlignment.start,
