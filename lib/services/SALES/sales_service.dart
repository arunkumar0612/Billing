              ...
              Positioned(
                ...
                child: IconButton(
                  ...
                  onPressed: () async {
                    ...
                    if ((dcController.dcModel.Dc_products.isNotEmpty) || (dcController.dcModel.Dc_noteList.isNotEmpty) || (dcController.dcModel.Dc_recommendationList.isNotEmpty) || (dcController.dcModel.clientAddressNameController.value.text != "") || (dcController.dcModel.clientAddressController.value.text != "") || (dcController.dcModel.billingAddressNameController.value.text != "") || (dcController.dcModel.billingAddressController.value.text != "") || (dcController.dcModel.Dc_no.value != "") || (dcController.dcModel.TitleController.value.text != "") || (dcController.dcModel.Dc_table_heading.value != "")) {
                      // Show confirmation dialog
                      bool? proceed = await showDialog<bool>(
                        context: context,
                        builder: (context) {
