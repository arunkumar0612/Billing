...
// Function to handle the recurred PDF file data
  /// This function processes the CMDmResponse, extracts the PDF file data, and updates the model.
  /// It converts the CMDmResponse to a PDFfileData object and extracts the File object from it.
  /// The recurred PDF file data is then used to update the recurred_pdfFile property in the subscription model.
...
// Function to add process data
  /// This function adds process data to the subscription model.
  /// It iterates through the data in the CMDlResponse and adds each process to the processList.
...
// Function to update the recurred PDF file in the model
  /// This function updates the recurred PDF file in the subscription model.
  /// It sets the recurred_pdfFile property to the provided File value.
  /// The recurred PDF file is used for recurring invoices in the subscription model.
...
// Function to clear the share data
  /// This function clears the share data in the subscription model.
  /// It resets the values of various controllers and selection statuses related to sharing subscription data.
  /// The share data includes email, phone, feedback, and WhatsApp/Gmail selection statuses.
