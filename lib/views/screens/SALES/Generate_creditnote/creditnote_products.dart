                        ...
                        Button1(
                          ...
                          onPressed: () {
                            ...
                            for (var entry in creditnote_productDetails) {
                              ...
                              creditnote_products.add(Product(index.toString(), entry['productName'] as String, entry['hsn'] as String, entry['gst'] as double, entry['price'] as double, entry['quantity'] as int, entry['remarks'] as String));
                              // }
                            }
