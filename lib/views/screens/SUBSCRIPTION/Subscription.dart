                      ...
                      Obx(
                        () => SizedBox(
                          ...
                          child: Stack(
                            ...
                            children: [
                              TextFormField(
                                controller: subscriptionController.subscriptionModel.searchQuery.value,
                                onChanged: subscriptionController.search,
                              ...
                              if (subscriptionController.subscriptionModel.searchQuery.value.text.isEmpty)
                                Positioned(
                                                    ...
                                                    Basic_dialog(
                                                      ...
                                                      onOk: () {
                                                        widget.ArchiveProcesscontrol(
                                                          context,
                                                          subscriptionController.subscriptionModel.selectedIndices
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child: Row(
                                                                          children: [
                                                                            ...
                                                                            if ((subscriptionController.subscriptionModel.processList[index].TimelineEvents[childIndex].Allowed_process.get_approval ==
                                                                                    true) &&
                                                                      ...
                                                                      Row(
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          if ((subscriptionController
                                                                                      .subscriptionModel.processList[index].TimelineEvents[childIndex].Allowed_process.revised_quatation ==
                                                                                  true)
                                                                              //  &&                                                                              (subscriptionController.subscriptionModel.processList[index].TimelineEvents.length == childIndex + 1)
                                                                              )
                                                                            TextButton(
                                                                          ...
                                                                          if ((subscriptionController.subscriptionModel.processList[index].TimelineEvents[childIndex].Allowed_process.rfq == true)
                                                                              // &&
                                                                              //     (subscriptionController.subscriptionModel.processList[index].TimelineEvents.length == childIndex + 1
                                                                              //     )
                                                                              )
                                                                            TextButton(
                                                                              onPressed: () async {
                                                                                ...
                                                                                if (success) {
                                                                                  ...
                                                                                  //     context, subscriptionController.subscriptionModel.processList[index].TimelineEvents[childIndex].Eventid);
                                                                                  // rfqController.setProcessID(subscriptionController.subscriptionModel.processList[index].processid);
                                                                                  // if (kDebugMode) {
                                                                          ...
                                                                          if ((subscriptionController.subscriptionModel.processList[index].TimelineEvents[childIndex].Allowed_process.invoice == true)
                                                                              // &&
                                                                              //     (subscriptionController.subscriptionModel.processList[index].TimelineEvents.length == childIndex + 1)
                                                                              )
                                                                            TextButton(
                                                                              onPressed: () async {
                                                                                ...
                                                                                if (success) {
                                                                                  ...
                                                                                  //     context, subscriptionController.subscriptionModel.processList[index].TimelineEvents[childIndex].Eventid);
                                                                                  // invoiceController.setProcessID(subscriptionController.subscriptionModel.processList[index].processid);
                                                                                  // if (kDebugMode) {
                                                                          ...
                                                                          if ((subscriptionController
                                                                                      .subscriptionModel.processList[index].TimelineEvents[childIndex].Allowed_process.delivery_challan ==
                                                                                  true)
                                                                              //  &&
                                                                              //     (subscriptionController.subscriptionModel.processList[index].TimelineEvents.length == childIndex + 1)
                                                                              )
                                                                            TextButton(
                                                                              onPressed: () async {
                                                                                ...
                                                                                if (success) {
                                                                                  ...
                                                                                  //     context, subscriptionController.subscriptionModel.processList[index].TimelineEvents[childIndex].Eventid);
                                                                                  // dcController.setProcessID(subscriptionController.subscriptionModel.processList[index].processid);
                                                                                  // if (kDebugMode) {
                                                                          ...
                                                                          if ((subscriptionController.subscriptionModel.processList[index].TimelineEvents[childIndex].Allowed_process.credit_note ==
                                                                                  true)
                                                                              // &&
                                                                          ...
                                                                          if ((subscriptionController.subscriptionModel.processList[index].TimelineEvents[childIndex].Allowed_process.debit_note ==
                                                                                  true)
                                                                              //  &&
                                                                              //     (subscriptionController.subscriptionModel.processList[index].TimelineEvents.length == childIndex + 1)
                                                                              )
