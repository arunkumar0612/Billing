...
import 'package:ssipl_billing/views/components/support_functions.dart';

List<Product> sub_invoice_products = [];
List<Map<String, dynamic>> sub_invoice_gstTotals = [];
//main
String sub_invoice_client_addr_name = "";
String sub_invoice_client_addr = "";
String sub_invoice_bill_addr_name = "";
String sub_invoice_bill_addr = "";
String sub_invoice_no = "";
String sub_invoice_title = "";
String sub_invoice_table_heading = "";
List<Map<String, dynamic>> sub_invoice_noteList = [];
List<Map<String, dynamic>> sub_invoice_recommendationList = [];
List<Map<String, dynamic>> sub_invoice_productDetails = [];

//

Future<Uint8List> generate_sub_invoice(PdfPageFormat pageFormat, products, client_addr_name, client_addr, bill_addr_name, bill_addr, sub_invoice_num, title, gst) async {
  final sub_invoice = sub_invoice_pdf(
    products: products,
    GST: gst.toDouble(),
  ...
  return await sub_invoice.buildPdf(pageFormat);
}

class sub_invoice_pdf {
  sub_invoice_pdf({
  ...
  double get CGST_total => sub_invoice_gstTotals.map((item) => (item['gst'] as double) / 2 * (item['total'] as double) / 100).reduce((a, b) => a + b);
  double get SGST_total => sub_invoice_gstTotals.map((item) => (item['gst'] as double) / 2 * (item['total'] as double) / 100).reduce((a, b) => a + b);
            ...
            pw.Container(
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  pw.ListView.builder(
                    itemCount: sub_invoice_gstTotals.length, // Number of items in the list
                      ...
                      return pw.Row(
                        children: [
                          pw.Container(
                            ...
                            width: 80,
                            height: 38,
                            child: pw.Center(child: regular(formatzero(sub_invoice_gstTotals[index]['total']), 10)),
                          ),
                          pw.Container(
                            height: 38,
                            child: pw.Row(
                              children: [
                                pw.Container(
                                  ...
                                  width: 40, // Define width instead of Expanded
                                  child: pw.Center(
                                    child: regular((sub_invoice_gstTotals[index]['gst'] / 2).toString(), 10),
                                  ),
                                ),
                                pw.Container(
                                  width: 70, // Define width instead of Expanded
                                  ...
                                  child: pw.Center(
                                    child: regular(
                                        formatzero(
                                          ((sub_invoice_gstTotals[index]['total'].toInt() / 100) * (sub_invoice_gstTotals[index]['gst'] / 2)),
                                        ),
                                        10),
                                  ),
                                ),
                            ...
                            child: pw.Row(
                              children: [
                                pw.Container(
                                  ...
                                  width: 40, // Define width instead of Expanded
                                  child: pw.Center(child: regular((sub_invoice_gstTotals[index]['gst'] / 2).toString(), 10)),
                                ),
                                pw.Container(
                                  width: 70, // Define width instead of Expanded
                                  decoration: const pw.BoxDecoration(
                                  ...
                                  child: pw.Center(child: regular(formatzero(((sub_invoice_gstTotals[index]['total'].toInt() / 100) * (sub_invoice_gstTotals[index]['gst'] / 2))), 10)),
                                ),
                              ],
                            ),
                          ),
    ...
    return pw.Container(
      ...
      child: pw.Column(
        ...
        children: [
          ...
          ...List.generate(sub_invoice_noteList.length, (index) {
            return pw.Padding(
              ...
              child: pw.Row(
                ...
                children: [
                  ...
                  pw.Expanded(
                    child: pw.Text(
                      sub_invoice_noteList[index]["notecontent"],
                      textAlign: pw.TextAlign.start,
                      style: pw.TextStyle(
                        font: Helvetica,
                        fontSize: 10,
          ...
          pw.Padding(
            ...
            child: pw.Row(
              crossAxisAlignment: pw.CrossAxisAlignment.start,
              children: [
                // regular("${sub_invoice_noteList.length + 1}.", 10),
                // pw.SizedBox(width: 5),
                // pw.Expanded(
                //   child: pw.Column(
                //     crossAxisAlignment: pw.CrossAxisAlignment.start,
          ...
          pw.Padding(
            ...
            child: pw.Row(
              crossAxisAlignment: pw.CrossAxisAlignment.start,
              children: [
                // regular("${sub_invoice_noteList.length + 2}.", 10),
                pw.SizedBox(width: 5),
                pw.Expanded(
                  child: pw.Column(
                    crossAxisAlignment: pw.CrossAxisAlignment.start,
                    children: [
                      bold(sub_invoice_table_heading, 10),
                      ...sub_invoice_recommendationList.map((recommendation) {
                        return pw.Padding(
