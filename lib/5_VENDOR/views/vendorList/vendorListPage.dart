                                                ...
                                                onPressed: () async {
                                                  ...
                                                  if (success) {
                                                    if (widget.vendorcontroller.vendorListModel.GSTregCertiFile.value != null) {
                                                      showPDF(context, widget.vendorcontroller.vendorListModel.GSTregCerti_uploadedPath.string, widget.vendorcontroller.vendorListModel.GSTregCertiFile.value);
                                                    } else {
                                                ...
                                                onPressed: () async {
                                                  ...
                                                  if (success) {
                                                    if (widget.vendorcontroller.vendorListModel.cancelledChequeFile.value != null) {
                                                      showPDF(context, widget.vendorcontroller.vendorListModel.cheque_uploadedPath.string, widget.vendorcontroller.vendorListModel.cancelledChequeFile.value);
                                                    } else {
