      ...
      children: [
        ...
        Expanded(
          child: ListView.separated(
            ...
            itemCount: gst_ledgerController.gst_LedgerModel.gst_Ledger_list.length,
                        ...
                        children: [
                          ...
                          Expanded(
                            ...
                            child: Padding(
                              padding: const EdgeInsets.all(10),
                              child: Text(
                                formatDate(gst_ledgerController.gst_LedgerModel.gst_Ledger_list[0].gstList[index].date),
                          ...
                          Expanded(
                            ...
                            child: Padding(
                              padding: const EdgeInsets.all(10),
                              child: Text(
                                gst_ledgerController.gst_LedgerModel.gst_Ledger_list[0].gstList[index].voucherNumber,
                                style: const TextStyle(color: Primary_colors.Color1, fontSize: Primary_font_size.Text7),
                              ),
                            ),
                          ),
                          ...
                          Expanded(
                            ...
                            child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      gst_ledgerController.gst_LedgerModel.gst_Ledger_list[0].gstList[index].gstNumber,
                                      style: const TextStyle(color: Primary_colors.Color1, fontSize: Primary_font_size.Text7),
                                    ),
                                  ],
                                )),
                          ...
                          Expanded(
                            ...
                            child: Padding(
                              padding: const EdgeInsets.all(10),
                              child: Text(
                                gst_ledgerController.gst_LedgerModel.gst_Ledger_list[0].gstList[index].gstType,
                                style: const TextStyle(color: Primary_colors.Color1, fontSize: Primary_font_size.Text7),
                              ),
                            ),
                          ),
                          ...
                          Expanded(
                            ...
                            child: Padding(
                              padding: const EdgeInsets.all(10),
                              child: Text(
                                gst_ledgerController.gst_LedgerModel.gst_Ledger_list[0].gstList[index].cgst.toString(),
                                style: const TextStyle(color: Primary_colors.Color1, fontSize: Primary_font_size.Text7),
                              ),
                            ),
                          ),
                          Expanded(
                            ...
                            child: Padding(
                              padding: const EdgeInsets.all(10),
                              child: Text(
                                gst_ledgerController.gst_LedgerModel.gst_Ledger_list[0].gstList[index].sgst.toString(),
                                style: const TextStyle(color: Primary_colors.Color1, fontSize: Primary_font_size.Text7),
                              ),
                            ),
                          ),
                          Expanded(
                            ...
                            child: Padding(
                              padding: const EdgeInsets.all(10),
                              child: Text(
                                gst_ledgerController.gst_LedgerModel.gst_Ledger_list[0].gstList[index].igst.toString(),
                                style: const TextStyle(color: Primary_colors.Color1, fontSize: Primary_font_size.Text7),
                              ),
                            ),
                          ),
                          ...
                          Expanded(
                            ...
                            child: Padding(
                              padding: const EdgeInsets.all(10),
                              child: Text(
                                gst_ledgerController.gst_LedgerModel.gst_Ledger_list[0].gstList[index].totalAmount.toString(),
                                style: const TextStyle(color: Primary_colors.Color1, fontSize: Primary_font_size.Text7),
                              ),
                            ),
                          ),
