                      ...
                      Obx(
                        () {
                          return
                              ...
                              //           color: Colors.white,
                              //         )),
                              //     // value: rfqController.rfqModel.productNameController.value.text,
                              //     items: rfqController.rfqModel.Rfq_productSuggestion.map((product) {
                      ...
                      Obx(
                        () {
                          return BasicTextfield(
                            ...
                            readonly: false,
                            text: 'HSN',
                            controller: rfqController.rfqModel.hsnController.value,
                            icon: Icons.numbers,
                            validator: (value) {
                              if (value == null || value.isEmpty) {
                        ...
                        child: Obx(
                          () {
                            return TextFormField(
                              ...
                              controller: rfqController.rfqModel.gstController.value,
                        ...
                        () {
                          return SizedBox(
                            ...
                            child: TextFormField(
                              ...
                              controller: rfqController.rfqModel.priceController.value,
                              keyboardType: TextInputType.number,
                              inputFormatters: [FilteringTextInputFormatter.digitsOnly],
                              validator: (value) {
                                if (value == null || value.isEmpty) {
