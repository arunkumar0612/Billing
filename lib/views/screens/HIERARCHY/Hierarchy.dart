...
import 'package:ssipl_billing/views/components/custom_Grid.dart';
...
class Enterprise_Hierarchy extends StatefulWidget {
  const Enterprise_Hierarchy({super.key});
...
class _Enterprise_HierarchyState extends State<Enterprise_Hierarchy> with SingleTickerProviderStateMixin {
  ...
  //   Navigator.push(
  //     context,
  //     MaterialPageRoute(builder: (context) => DetailsPage(id: id)), // Replace with your page
  //   );
  // }
