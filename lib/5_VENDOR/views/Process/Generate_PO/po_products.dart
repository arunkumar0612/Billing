...
import '../../../models/entities/Process/PO_entities.dart';
                ...
                Expanded(
                  child: Column(
                    children: [
                      ...
                      Obx(
                        () {
                          return DropdownMenu<ProductSuggestion>(
                            ...
                            dropdownMenuEntries: poController.poModel.VendorProduct_sugestions.map<DropdownMenuEntry<ProductSuggestion>>((suggestion) {
                        ...
                        () {
                          return SizedBox(
                            ...
                            child: TextFormField(
                              ...
                              inputFormatters: [FilteringTextInputFormatter.digitsOnly],
                              controller: poController.poModel.gstController.value,
                              keyboardType: TextInputType.number,
                              // inputFormatters: [
                              //   FilteringTextInputFormatter.digitsOnly
                              // ],
                      ...
                      const SizedBox(height: 25),
                      Obx(() {
                        return poController.poModel.lastknown_price.value != null
                            ? SizedBox(
                                width: 400,
                                child: Row(
                                  mainAxisAlignment: MainAxisAlignment.start,
                                  children: [
                                    Text(
                                      'Last Price  :  ${poController.poModel.lastknown_price.value.toString()}',
