...
Future<Uint8List> TDSledger_excelTemplate(TDSSummaryModel tds_Ledger_list) async {
  ...
  sheet1
      .getRangeByName('A2')
      .setText('TDS LEDGER SUMMARY (From ${_formatDate(DateTime.parse(tds_Ledger_list.startdate.toString()))} to ${_formatDate(DateTime.parse(tds_Ledger_list.enddate.toString()))})');
