...
class VendorChart extends StatefulWidget {
  ...
  @override
  VendorChartState createState() => VendorChartState();
}
...
class VendorChartState extends State<VendorChart> {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      final int completed = vendorController.vendorModel.vendordata.value?.paidinvoices ?? 0;
      final int pending = vendorController.vendorModel.vendordata.value?.unpaidinvoices ?? 0;
