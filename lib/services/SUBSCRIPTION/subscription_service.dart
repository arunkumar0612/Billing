...
// import 'package:ssipl_billing/views/screens/SUBSCRIPTION/Generate_DC/generateDC.dart';
// import 'package:ssipl_billing/views/screens/SUBSCRIPTION/Generate_RFQ/generateRFQ.dart';
...
// import '../../views/screens/SUBSCRIPTION/Generate_DebitNote/generateDebit.dart';
// import '../../views/screens/SUBSCRIPTION/Generate_Invoice/generateInvoice.dart';
// import '../../views/screens/SUBSCRIPTION/Generate_Quote/generateQuote.dart';
// import '../../views/screens/SUBSCRIPTION/Generate_client_req/generate_clientreq.dart';
// import '../../views/screens/SUBSCRIPTION/Generate_creditNote/generateCredit.dart';
...
mixin SubscriptionServices {
  ...
  void GetCustomerList(context) async {
    try {
      Map<String, dynamic>? response = await apiController.GetbyToken('API.subscription_getcustomerlist_API');
      if (response?['statusCode'] == 200) {
        ...
        if (value.code) {
          ...
          subscriptionController.addToCustomerList(value);
          // if (kDebugMode) {
          //   print("*****************${subscriptionController.subscriptionModel.customerList[1].customerId}");
          // }
        } else {
