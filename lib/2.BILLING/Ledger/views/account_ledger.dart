                        ...
                        children: [
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    textAlign: TextAlign.start,
                                    account_ledgerController.account_LedgerModel.account_Ledger_list[index].debitAmount.toString(),
                                    style: const TextStyle(color: Primary_colors.Color1, fontSize: Primary_font_size.Text7),
                                  ),
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    textAlign: TextAlign.start,
                                    account_ledgerController.account_LedgerModel.account_Ledger_list[index].creditAmount.toString(),
                                    style: const TextStyle(color: Primary_colors.Color1, fontSize: Primary_font_size.Text7),
                                  ),
                          ...
                          Expanded(
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                textAlign: TextAlign.end,
                                account_ledgerController.account_LedgerModel.account_Ledger_list[index].totalAmount.toString(),
                                style: const TextStyle(color: Primary_colors.Color1, fontSize: Primary_font_size.Text7),
                              ),
                            ),
                          ),
