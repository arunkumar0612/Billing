...
class _sub_invoiceNoteState extends State<sub_invoiceNote> {
  ...
  void _addtable_row() {
    sub_invoice_table_heading = Rec_HeadingController.text;
    ...
    setState(
      () {
        ...
        Rec_Length = sub_invoice_recommendationList.length;
        _cleartable_Fields();
      },
    );
    // }
  ...
  Widget build(BuildContext context) {
    sub_invoice_recommendationList.isEmpty ? Rec_HeadingController.clear() : null;
                ...
                children: [
                  ...
                  if (sub_invoice_noteList.isNotEmpty || sub_invoice_recommendationList.isNotEmpty)
                    BasicButton(
                      ...
                      text: 'Submit',
                      onPressed: () async {
                        if (sub_invoice_products.isNotEmpty && sub_invoice_gstTotals.isNotEmpty && sub_invoice_productDetails.isNotEmpty && sub_invoice_client_addr_name != "" && sub_invoice_client_addr != "" && sub_invoice_bill_addr_name != "" && sub_invoice_bill_addr != "" && sub_invoice_title != "") {
                          final pdfData = await generate_sub_invoice(PdfPageFormat.a4, sub_invoice_products, sub_invoice_client_addr_name, sub_invoice_client_addr, sub_invoice_bill_addr_name, sub_invoice_bill_addr, sub_invoice_no, sub_invoice_title, 9);
