                                            ...
                                            child: GestureDetector(
                                              onTap: () async {
                                                ...
                                                if (success) {
                                                  ...
                                                  Basic_SnackBar(context, "ERROR viewing file, Please contact administration!");
                                                }
                                              },
                                                                        ...
                                                                        child: SizedBox(
                                                                          ...
                                                                          child: TextFormField(
                                                                            ...
                                                                            decoration: InputDecoration(
                                                                              ...
                                                                              fillColor: Primary_colors.Dark,
                                                                              focusedBorder:
                                                                                  OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: const BorderSide(color: Colors.transparent)),
                                                                              // enabledBorder: InputBorder.none, // Removes the enabled border
                                                                              enabledBorder:
                                                                                  OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: const BorderSide(color: Colors.transparent)),
                                                                              hintStyle: const TextStyle(
                                                                        ...
                                                                        child: GestureDetector(
                                                                          onTap: () async {
                                                                            ...
                                                                            if (success) {
                                                                              ...
                                                                              Basic_SnackBar(context, "ERROR sending file, Please contact administration!");
                                                                            }
                                                                          },
                                                                          child: Container(
                                                                            width: 105,
                                            ...
                                            child: GestureDetector(
                                              onTap: () async {
                                                ...
                                                if (success) {
                                                  ...
                                                  Basic_SnackBar(context, "ERROR downloading file, Please conatct administration!");
                                                }
                                              },
