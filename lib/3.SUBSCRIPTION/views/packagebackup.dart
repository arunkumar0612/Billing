...
//                 ),
//                 Text(
//                   'Totol : ${subscriptions.length} Plans',
//                   style: theme.textTheme.bodyLarge?.copyWith(color: Colors.white, fontWeight: FontWeight.w500, fontSize: Primary_font_size.Text8, letterSpacing: 1.0),
//                 ),
//               ],
//             ),
//           ),
...
//   // Add this to the _SubscriptionPageState class
...
//                       Text(
//                         'Plan Name',
//                         style: Theme.of(context).textTheme.titleMedium?.copyWith(color: Colors.white, fontWeight: FontWeight.bold, fontSize: Primary_font_size.Text8),
//                       ),
...
//                             hintStyle: TextStyle(color: Colors.white54, fontSize: Primary_font_size.Text8),
//                           ),
//                           onChanged: (value) => newSubscription.name = value,
//                         ),
//                       ),
//                       const SizedBox(height: 24),
...
//                             hintStyle: TextStyle(color: Colors.white54, fontSize: Primary_font_size.Text8),
//                           ),
//                           onChanged: (value) => newSubscription.description = value,
//                         ),
//                       ),
...
//                                       hintStyle: TextStyle(color: Colors.white54, fontSize: Primary_font_size.Text8),
//                                     ),
//                                     onChanged: (value) => newSubscription.price = double.tryParse(value) ?? 0,
//                                   ),
//                                 ),
//                               ],
//                             ),
...
//                                     dropdownColor: const Color.fromARGB(255, 31, 45, 95),
//                                     style: const TextStyle(color: Colors.white, fontSize: Primary_font_size.Text8),
//                                     decoration: const InputDecoration(
//                                       border: InputBorder.none,
...
//                                     onChanged: (value) {
//                                       if (value != null) {
//                                         newSubscription.duration = value;
//                                       }
//                                     },
//                                   ),
//                                 ),
...
//                           children: [
//                             Switch(
//                               value: newSubscription.isPopular,
//                               onChanged: (value) => setState(() => newSubscription.isPopular = value),
...
//                               style: Theme.of(context).textTheme.bodyLarge?.copyWith(color: Colors.white, fontSize: Primary_font_size.Text8),
//                             ),
//                             const Spacer(),
//                             if (newSubscription.isPopular)
//                               Container(
...
//                                 child: Text(
//                                   'POPULAR',
//                                   style: Theme.of(context).textTheme.labelSmall?.copyWith(color: Colors.amber, fontWeight: FontWeight.bold, letterSpacing: 1.2, fontSize: Primary_font_size.Text8),
//                                 ),
//                               ),
//                           ],
//                         ),
...
//                       ),
//                       const SizedBox(height: 8),
//                       ...newSubscription.features.map((feature) => Padding(
...
//                                       ),
//                                       onChanged: (value) {
//                                         final index = newSubscription.features.indexOf(feature);
//                                         if (index >= 0) {
//                                           newSubscription.features[index] = value;
//                                         }
//                                       },
//                                     ),
//                                   ),
...
//                                 const SizedBox(width: 12),
//                                 IconButton(
//                                   icon: const Icon(Icons.remove_circle, color: Color.fromARGB(255, 214, 213, 213), size: 28),
//                                   onPressed: () => setState(() => newSubscription.features.remove(feature)),
//                                 ),
//                               ],
//                             ),
//                           )),
...
//                         label: const Text(
//                           'Add Another Feature',
//                           style: TextStyle(fontSize: Primary_font_size.Text8),
//                         ),
...
//                         ),
//                         onPressed: () => setState(() => newSubscription.features.add('')),
//                       ),
...
//                           style: ElevatedButton.styleFrom(
//                             backgroundColor: Colors.blueAccent, // Changed from Primary_colors.Color3
//                             shape: RoundedRectangleBorder(
//                               borderRadius: BorderRadius.circular(12),
//                             ),
...
//                           ),
//                           onPressed: () {
//                             if (newSubscription.name.isNotEmpty && newSubscription.price > 0 && newSubscription.description.isNotEmpty) {
//                               setState(() {
//                                 SubscriptionRepository.addSubscription(newSubscription);
//                                 _selectedPackages.add(false);
//                                 _selectedSubscription = newSubscription;
//                                 _pageController.jumpToPage(SubscriptionRepository.getSubscriptions().length - 1);
//                               });
//                               Navigator.pop(context);

//                               ScaffoldMessenger.of(context).showSnackBar(
//                                 SnackBar(
//                                   content: Text('"${newSubscription.name}" plan created successfully!'),
...
// // Add this to the Scaffold in the build method (inside the Stack, after the SafeArea)
// }
...
//                                 child: Text(
//                                   feature,
//                                   style: theme.textTheme.bodyMedium?.copyWith(color: Colors.white.withOpacity(0.8), fontSize: Primary_font_size.Text6),
//                                 ),
//                               ),
//                             ],
//                           ),
...
//                                         style: theme.textTheme.titleLarge?.copyWith(color: Colors.white.withOpacity(0.9), fontWeight: FontWeight.bold, fontSize: Primary_font_size.Text10),
//                                         keyboardType: TextInputType.number,
//                                         decoration: InputDecoration(
//                                           border: InputBorder.none,
//                                           hintText: 'Price',
...
//                                         style: theme.textTheme.bodyLarge?.copyWith(color: Colors.white, fontSize: Primary_font_size.Text8),
//                                         decoration: InputDecoration(
//                                           hintText: 'Enter feature',
...
//                                   style: theme.textTheme.bodyLarge?.copyWith(color: Colors.white70, fontSize: Primary_font_size.Text8),
//                                   maxLines: 3,
//                                   decoration: InputDecoration(
...
//                                   style: theme.textTheme.bodyLarge?.copyWith(color: Colors.white70, height: 1.6, fontSize: Primary_font_size.Text8),
//                                 ),
//                         ],
//                       ),
//                     ),
...
//                                 child: Text(
//                                   'CANCEL',
//                                   style: theme.textTheme.labelLarge?.copyWith(fontWeight: FontWeight.bold, color: Primary_colors.Dark, letterSpacing: 1.2, fontSize: Primary_font_size.Text8),
//                                 ),
//                               ),
//                             ),
//                           ],
...
//       ],
//       description: 'Perfect for individual users who primarily watch content on their mobile devices...',
...
//         'Cancel anytime with no fees',
//       ],
//       description: 'Our most popular plan with excellent value...',
...
//         'Cancel anytime with no fees',
//       ],
//       description: 'Ideal for families with multiple viewers...',
...
//     return List.from(_subscriptions); // Return a copy to prevent external modification
//   }
