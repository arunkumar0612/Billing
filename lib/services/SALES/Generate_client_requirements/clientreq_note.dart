...
import 'package:ssipl_billing/services/SALES/Generate_client_requirements/clientreq_template.dart';
import 'package:ssipl_billing/services/SALES/Generate_client_requirements/view_clientreq_send.dart';
                ...
                children: [
                  ...
                  if (clientreqNote.clientreq_noteList.isNotEmpty || clientreqNote.clientreq_recommendationList.isNotEmpty)
                    Button1(
                      ...
                      text: 'Submit',
                      onPressed: () async {
                        if (clientreqProducts.clientreq_productDetails.isNotEmpty && clientreqProducts.clientreq_productDetails.isNotEmpty && clientreqDetails.clientnameController.text.isNotEmpty && clientreqDetails.clientaddressController.text.isNotEmpty && clientreqDetails.billingaddressnameController.text.isNotEmpty && clientreqDetails.billingaddressController.text.isNotEmpty) {
                          final pdfData = await generate_clientreq(PdfPageFormat.a4, clientreqProducts.clientreq_productDetails, clientreqDetails.clientnameController.text, clientreqDetails.clientaddressController.text, clientreqDetails.billingaddressnameController.text, clientreqDetails.billingaddressController.text, clientreqDetails.clientreq_no, clientreqDetailsState.pickedFile!.files.single.path);
