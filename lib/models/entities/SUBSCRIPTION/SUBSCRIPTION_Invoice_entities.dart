...
class SUBSCRIPTION_Recommendation {
  final String key;
  final String value;
  ...
  factory SUBSCRIPTION_Recommendation.fromJson(Map<String, dynamic> json) {
    return SUBSCRIPTION_Recommendation(
...
//   }
// }
class SUBSCRIPTION_InvoiceGSTtotals {
  final double gst;
  final double total;

  SUBSCRIPTION_InvoiceGSTtotals({
    required this.gst,
    required this.total,
  });

  factory SUBSCRIPTION_InvoiceGSTtotals.fromJson(Map<String, dynamic> json) {
    return SUBSCRIPTION_InvoiceGSTtotals(gst: json['GST'], total: json['total']);
  }
...
class SUBSCRIPTION_RequiredData {
  ...
  factory SUBSCRIPTION_RequiredData.fromJson(CMDmResponse json) {
    return SUBSCRIPTION_RequiredData(
...
class SUBSCRIPTION_Post_Invoice {
  String? title;
  int? processid;
  ...
  factory SUBSCRIPTION_Post_Invoice.fromJson({
    ...
    return SUBSCRIPTION_Post_Invoice(
        title: title,
        processid: processid,
...
class SUBSCRIPTION_SiteSuggestion {
  ...
  factory SUBSCRIPTION_SiteSuggestion.fromJson(Map<String, dynamic> json) {
    return SUBSCRIPTION_SiteSuggestion(
