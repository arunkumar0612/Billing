...
mixin PostServices {
  ...
  void animation_control() async {
    ...
    quoteController.setLoading(false);
    ...
    quoteController.setLoading(true);
  }
  ...
  dynamic send_data(context, String jsonData, File file) async {
    try {
      Map<String, dynamic>? response = await apiController.Multer(sessiontokenController.sessiontokenModel.sessiontoken.value, jsonData, file, API.add_Quotation);
