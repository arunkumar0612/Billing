                                    ...
                                    children: [
                                                                ...
                                                                Row(
                                                                  ...
                                                                  children: [
                                                                    MouseRegion(
                                                                      ...
                                                                      child: GestureDetector(
                                                                        onTap: () async {
                                                                          await widget.Get_RecurredPDFfile(
                                                                            context,
                                                                            subscriptionController.subscriptionModel.reccuringInvoice_list[index].recurredbillid,
                                                                          );
                                      ...
                                      Expanded(
                                        ...
                                        child: Align(
                                          ...
                                          child: GestureDetector(
                                            onTap: () {
                                              widget.Get_RecurredPDFfile(context, subscriptionController.subscriptionModel.reccuringInvoice_list[index].recurredbillid);
                                              widget.downloadPdf(
                                                  context,
