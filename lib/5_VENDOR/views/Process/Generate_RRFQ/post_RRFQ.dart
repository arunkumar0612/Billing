...
import 'package:ssipl_billing/5_VENDOR/services/Process/RRFQ_services/RRFQ_Post_services.dart';
...
class PostRrfq extends StatefulWidget with PostServices {
  String type;
  PostRrfq({super.key, required this.type});

  @override
  State<PostRrfq> createState() => PostRrfqState();
}

class PostRrfqState extends State<PostRrfq> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    // rrfqController.rrfqModel.selected
    // Pdf.value = File(widget.type);
    rrfqController.rrfqModel.filePathController.value = TextEditingController(text: rrfqController.rrfqModel.selectedPdf.value?.path.toString());

    rrfqController.rrfqModel.animationController = AnimationController(
      duration: const Duration(seconds: 2),
      vsync: this,
    )..repeat(reverse: true);

    rrfqController.rrfqModel.animation = Tween<double>(begin: 0.0, end: 1.0).animate(
      CurvedAnimation(
        parent: rrfqController.rrfqModel.animationController,
        curve: Curves.linear,
      ),
    );
  ...
  //     "feedback": "Rrfq for your request",
  //     "documenttype": "Rrfq"
  //   };
  ...
  @override
  void dispose() {
    rrfqController.rrfqModel.animationController.dispose(); // Dispose of the animation controller
    rrfqController.rrfqModel.filePathController.value.dispose(); // Dispose of the text controller
    super.dispose();
  }
        ...
        return SizedBox(
          ...
          child: Row(
            children: [
              ...
              rrfqController.rrfqModel.ispdfLoading.value
                  ? Expanded(
                      child: GestureDetector(
                        child: Stack(
                          children: [
                            rrfqController.rrfqModel.selectedPdf.value != null
                                ? PDFviewonly.dialogWidget(rrfqController.rrfqModel.selectedPdf.value!)
                                : Container(
                                    color: Colors.white,
                                    child: const Column(
                        ...
                        onDoubleTap: () {
                          if (rrfqController.rrfqModel.selectedPdf.value != null) {
                            PDFviewonly.show(context, rrfqController.rrfqModel.selectedPdf.value!);
                            // PDFviewonly. (context, rrfqController.rrfqModel.selectedPdf.value!);
                  ...
                  : Expanded(
                      child: Stack(
                        children: [
                          ...
                          AnimatedBuilder(
                            animation: rrfqController.rrfqModel.animation,
                            builder: (context, child) {
                              return Positioned(
                                top: (590) * rrfqController.rrfqModel.animation.value, // Adjust top position
                                left: 0,
                                right: 0,
                                child: Padding(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          path.basename(rrfqController.rrfqModel.selectedPdf.value?.path ?? ""),
                    ...
                    if (rrfqController.rrfqModel.whatsapp_selectionStatus.value)
                      Row(
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                          const Text(
                    ...
                    if (rrfqController.rrfqModel.gmail_selectionStatus.value)
                      Column(
                        children: [
                          Row(
                            crossAxisAlignment: CrossAxisAlignment.center,
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      suffixIcon: MouseRegion(
                                        ...
                                        child: GestureDetector(
                                          onTap: () {
                                            rrfqController.toggleCCemailvisibility(!rrfqController.rrfqModel.CCemailToggle.value);
                                          },
                                          child: SizedBox(
                                            height: 20,
                                            width: 20,
                                            child: Stack(
                                              children: [
                                                Align(
                                                  ...
                                                  child: Icon(
                                                    rrfqController.rrfqModel.CCemailToggle.value ? Icons.closed_caption_outlined : Icons.closed_caption_disabled_outlined,
                                                    color: Colors.blue,
                                                  ),
                                                ),
                                                const Align(
                          ...
                          if (rrfqController.rrfqModel.CCemailToggle.value)
                            const SizedBox(
                              height: 10,
                            ),
                          if (rrfqController.rrfqModel.CCemailToggle.value)
                                ...
                                Expanded(
                                  child: SizedBox(
                                    ...
                                    child: TextFormField(
                                      ...
                                      controller: rrfqController.rrfqModel.CCemailController.value,
                        ...
                        Expanded(
                          child: SizedBox(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                suffixIcon: Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: TextButton(
                                      onPressed: () {
                                        rrfqController.pickFile(context);
                                      },
                                      child: const Text(
                                        'Choose',
                                        style: TextStyle(
                              ...
                              controller: rrfqController.rrfqModel.filePathController.value,
                            ),
                          ),
                        ),
                      ],
                              ...
                              Stack(
                                ...
                                children: [
                                  IconButton(
                                    iconSize: 30,
                                    onPressed: () {
                                      rrfqController.rrfqModel.whatsapp_selectionStatus.value = rrfqController.rrfqModel.whatsapp_selectionStatus.value == false ? true : false;
                                    },
                                    icon: Image.asset(
                              ...
                              Stack(
                                ...
                                children: [
                                  IconButton(
                                    iconSize: 35,
                                    onPressed: () {
                                      rrfqController.rrfqModel.gmail_selectionStatus.value = rrfqController.rrfqModel.gmail_selectionStatus.value == false ? true : false;
                                    },
                    ...
                    SizedBox(
                      ...
                      child: TextField(
                        ...
                        controller: rrfqController.rrfqModel.feedbackController.value,
                      ),
                    ),
                    const SizedBox(
                      height: 10,
                        ...
                        Padding(
                          ...
                          child: Align(
                              ...
                              child: BasicButton(
                                  ...
                                  colors: Colors.red,
                                  onPressed: () {
                                    rrfqController.backTab();
                                  })),
                        ),
                        if (rrfqController.rrfqModel.whatsapp_selectionStatus.value || rrfqController.rrfqModel.gmail_selectionStatus.value)
                          Padding(
                            padding: const EdgeInsets.only(right: 10),
                            child: Align(
                                alignment: Alignment.centerRight,
                                child: BasicButton(
                                    ...
                                    colors: Colors.blue,
                                    onPressed: () {
                                      widget.postData(context, rrfqController.fetch_messageType());
                                    })),
                          )
                      ],
                    )
