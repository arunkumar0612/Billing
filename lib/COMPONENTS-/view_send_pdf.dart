...
// import 'package:ssipl_billing/services/SALES/Quotation_services/QuoteNotes_service.dart';
...
// class Generate_popup extends StatefulWidget with PostServices {
//   String type;
...
//     viewsendController.quoteModel.selectedPdf.value = File(widget.type);
//     viewsendController.quoteModel.filePathController.value = TextEditingController(text: viewsendController.quoteModel.selectedPdf.value!.path.toString());

//     viewsendController.quoteModel.animationController = AnimationController(
//       duration: const Duration(seconds: 2),
//       vsync: this,
//     )..repeat(reverse: true);

//     viewsendController.quoteModel.animation = Tween<double>(begin: 0.0, end: 1.0).animate(
//       CurvedAnimation(
//         parent: viewsendController.quoteModel.animationController,
//         curve: Curves.linear,
//       ),
//     );
...
//   @override
//   void dispose() {
//     viewsendController.quoteModel.animationController.dispose(); // Dispose of the animation controller
//     viewsendController.quoteModel.filePathController.value.dispose(); // Dispose of the text controller
//     super.dispose();
//   }
...
//                 width: 10,
//               ),
//               viewsendController.quoteModel.isLoading.value
//                   ? Expanded(
//                       child: Container(
...
//                           child: Stack(
//                             children: [
//                               SfPdfViewer.file(viewsendController.quoteModel.selectedPdf.value!),
//                               Align(
...
//                           AnimatedBuilder(
//                             animation: viewsendController.quoteModel.animation,
//                             builder: (context, child) {
//                               return Positioned(
//                                 top: (590) * viewsendController.quoteModel.animation.value, // Adjust top position
//                                 left: 0,
//                                 right: 0,
//                                 child: Padding(
...
//                         ),
//                         Text(
//                           path.basename(viewsendController.quoteModel.selectedPdf.value.toString()),
...
//                               width: 400,
//                               readonly: false,
//                               controller: viewsendController.quoteModel.phoneController.value,
...
//                               width: 400,
//                               readonly: false,
//                               controller: viewsendController.quoteModel.emailController.value,
//                               text: 'Enter Email ID',
//                               icon: Icons.email,
//                               validator: (value) {
...
//                               ),
//                               controller: viewsendController.quoteModel.filePathController.value,
//                             ),
//                           ),
//                         ),
//                       ],
...
//                                     iconSize: 30,
//                                     onPressed: () {
//                                       viewsendController.quoteModel.whatsapp_selectionStatus.value = viewsendController.quoteModel.whatsapp_selectionStatus.value == false ? true : false;
//                                     },
//                                     icon: Image.asset(
//                                       'assets/images/whatsapp.png',
//                                     ),
//                                   ),
//                                   if (viewsendController.quoteModel.whatsapp_selectionStatus.value)
//                                     Align(
...
//                                     iconSize: 35,
//                                     onPressed: () {
//                                       viewsendController.quoteModel.gmail_selectionStatus.value = viewsendController.quoteModel.gmail_selectionStatus.value == false ? true : false;
//                                     },
//                                     icon: Image.asset('assets/images/gmail.png'),
//                                   ),
//                                   if (viewsendController.quoteModel.gmail_selectionStatus.value)
//                                     Align(
//                                       // alignment: Alignment.topLeft,
//                                       child: Container(
//                                           decoration: BoxDecoration(
...
//                           border: const OutlineInputBorder(),
//                         ),
//                         controller: viewsendController.quoteModel.feedbackController.value,
//                       ),
//                     ),
//                     const SizedBox(
//                       height: 10,
