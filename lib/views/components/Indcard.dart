...
class BranchCard extends StatefulWidget {
  ...
  const BranchCard({super.key, required this.name, required this.email, required this.id, required this.imageBytes, required this.index});
...
class _BranchCardState extends State<BranchCard> {
  ...
  void onSelected() {
    for (var org in BranchGrid.branches) {
      org.isSelected = false;
    }
    BranchGrid.branches[widget.index].isSelected = true;
    BranchGrid.branches.refresh();
  }
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      bool isSelected = BranchGrid.branches[widget.index].isSelected;
