...
Future<Uint8List> generate_RRFQ(
  ...
  return await RRFQ.buildPdf(pageFormat);
}

class Request_for_quote {
  Request_for_quote(
      {required this.RRFQ_no,
    ...
    return pw.Container(
      ...
      child: pw.Column(
        ...
        children: [
          ...
          // First note item
          ...List.generate(rrfqController.rrfqModel.Rrfq_noteList.length, (index) {
            return pw.Padding(
              ...
              child: pw.Row(
                ...
                children: [
                  ...
                  pw.Expanded(
                    child: pw.Text(
                      rrfqController.rrfqModel.Rrfq_noteList[index],
                      textAlign: pw.TextAlign.start,
                      style: pw.TextStyle(
                        font: Helvetica,
                        fontSize: 10,
          ...
          if (rrfqController.rrfqModel.Rrfq_recommendationList.isNotEmpty)
            pw.Padding(
              padding: const pw.EdgeInsets.only(left: 0, top: 8),
              child: pw.Row(
                crossAxisAlignment: pw.CrossAxisAlignment.start,
                children: [
                  regular("${rrfqController.rrfqModel.Rrfq_noteList.length + 1}.", 10),
                  pw.SizedBox(width: 5),
                  pw.Expanded(
                    child: pw.Column(
                      crossAxisAlignment: pw.CrossAxisAlignment.start,
                      children: [
                        bold(rrfqController.rrfqModel.recommendationHeadingController.value.text, 10),
                        ...rrfqController.rrfqModel.Rrfq_recommendationList.map((recommendation) {
                          return pw.Padding(
          ...
          pw.Padding(
            ...
            child: pw.Row(
              crossAxisAlignment: pw.CrossAxisAlignment.start,
              children: [
                regular("${rrfqController.rrfqModel.Rrfq_noteList.length + (rrfqController.rrfqModel.Rrfq_recommendationList.isEmpty ? 1 : 2)}.", 10),
                pw.SizedBox(width: 5),
                pw.Expanded(
                  child: pw.Column(
                    crossAxisAlignment: pw.CrossAxisAlignment.start,
