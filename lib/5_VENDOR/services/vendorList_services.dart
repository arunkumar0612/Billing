...
mixin VendorlistServices {
  ...
  dynamic send_data(BuildContext context, String jsonData, String type) async {
    try {
      bool isFileChanged = vendorListController.vendorListModel.logoFileChanged.value || vendorListController.vendorListModel.gstRegFileChanged.value || vendorListController.vendorListModel.panFileChanged.value || vendorListController.vendorListModel.chequeFileChanged.value;
