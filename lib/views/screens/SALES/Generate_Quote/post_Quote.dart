...
class PostQuote extends StatefulWidget with PostServices {
  String type;
  PostQuote({super.key, required this.type});
...
class PostQuoteState extends State<PostQuote> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    quoteController.quoteModel.selectedPdf.value = File(widget.type);
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          path.basename(quoteController.quoteModel.selectedPdf.value.toString()),
                    ...
                    Padding(
                      ...
                      child: Align(
                          ...
                          child: BasicButton(
                              ...
                              colors: Colors.blue,
                              onPressed: () {
                                widget.postData(context, quoteController.fetch_messageType());
                              })),
                    )
                  ],
                ),
