                                                ...
                                                children: [
                                                  Expanded(
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: Center(
                                                        child: Text(
                                                          formatzero(pdfpopup_controller.pdfModel.value.manualInvoice_gstTotals[index].gst).toString(),
                                                          style: const TextStyle(fontSize: Primary_font_size.Text7, overflow: TextOverflow.ellipsis),
                                                        ),
                                                      ),
                                                    ),
                                                  ...
                                                  Expanded(
                                                    ...
                                                    child: Center(
                                                      child: Text(
                                                        formatzero((pdfpopup_controller.pdfModel.value.manualInvoice_gstTotals[index].total.toInt() / 100) *
                                                                pdfpopup_controller.pdfModel.value.manualInvoice_gstTotals[index].gst)
                                                            .toString(),
                                                        style: const TextStyle(fontSize: Primary_font_size.Text7, overflow: TextOverflow.ellipsis),
                                                      ),
                                                    ),
