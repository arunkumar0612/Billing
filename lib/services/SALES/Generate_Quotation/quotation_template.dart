...
List<Product> quote_products = [];
List<Map<String, dynamic>> quote_gstTotals = [];
//main
String quote_client_addr_name = "";
String quote_client_addr = "";
String quote_bill_addr_name = "";
String quote_bill_addr = "";
String quote_estimate_no = "";
String quote_title = "";
String quote_table_heading = "";
List<Map<String, dynamic>> quote_noteList = [];
List<Map<String, dynamic>> quote_recommendationList = [];
List<Map<String, dynamic>> quote_productDetails = [];

Future<Uint8List> generate_Quotation(PdfPageFormat pageFormat, products, client_addr_name, client_addr, bill_addr_name, bill_addr, estimate_num, title, gst) async {
    ...
    return pw.Container(
      ...
      child: pw.Column(
        ...
        children: [
          ...
          ...List.generate(quote_noteList.length, (index) {
            return pw.Padding(
              ...
              child: pw.Row(
                ...
                children: [
                  ...
                  pw.Expanded(
                    child: pw.Text(
                      quote_noteList[index]["notecontent"],
                      textAlign: pw.TextAlign.start,
                      style: pw.TextStyle(
                        font: Helvetica,
                        fontSize: 10,
          ...
          pw.Padding(
            ...
            child: pw.Row(
              crossAxisAlignment: pw.CrossAxisAlignment.start,
              children: [
                regular("${quote_noteList.length + 1}.", 10),
                pw.SizedBox(width: 5),
                pw.Expanded(
                  child: pw.Column(
                    crossAxisAlignment: pw.CrossAxisAlignment.start,
          ...
          pw.Padding(
            ...
            child: pw.Row(
              crossAxisAlignment: pw.CrossAxisAlignment.start,
              children: [
                regular("${quote_noteList.length + 2}.", 10),
                pw.SizedBox(width: 5),
                pw.Expanded(
                  child: pw.Column(
                    crossAxisAlignment: pw.CrossAxisAlignment.start,
                    children: [
                      bold(quote_table_heading, 10),
                      ...quote_recommendationList.map((recommendation) {
                        return pw.Padding(
