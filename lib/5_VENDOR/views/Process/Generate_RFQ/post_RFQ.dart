...
import 'package:ssipl_billing/5_VENDOR/services/Process/RFQ_services/RFQ_Post_services.dart';
                        ...
                        Padding(
                          ...
                          child: Align(
                              ...
                              child: BasicButton(
                                  ...
                                  colors: Colors.red,
                                  onPressed: () {
                                    rfqController.backTab();
                                  })),
                        ),
                        if (rfqController.rfqModel.whatsapp_selectionStatus.value || rfqController.rfqModel.gmail_selectionStatus.value)
                          Padding(
                            padding: const EdgeInsets.only(right: 10),
                            child: Align(
                                alignment: Alignment.centerRight,
