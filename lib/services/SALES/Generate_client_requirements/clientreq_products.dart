...
class _clientreqProductsState extends State<clientreqProducts> {
  ...
  void _addproduct() {
    if (formKey1.currentState?.validate() ?? false) {
      ...
      bool exists = clientreqProducts.clientreq_productDetails.any((product) => product['productname'] == productNameController.text && product['productquantity'] == int.parse(quantityController.text));
