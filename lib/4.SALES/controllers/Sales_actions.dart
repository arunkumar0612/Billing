...
class SalesController extends GetxController {
  ...
  void search(String query) {
    ...
    if (query.isEmpty) {
      ...
      var filteredProcesses = salesfilteredModel.processList.where(
          (process) => process.title.toLowerCase().contains(query.toLowerCase()) || process.customer_name.toLowerCase().contains(query.toLowerCase()) || process.Process_date.toLowerCase().contains(query.toLowerCase()));
